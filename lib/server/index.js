...
const bld = path.join(process.cwd(), 'build')	// should be run with `yarn start`
...
app.use(express.static(pub))	// static file hosting. Anything in public will be found under "/"
